...
const ACCEPTED_ORIGINS: string[] = ['http://localhost:5173','http://localhost:4173','http://localhost:5173', 'http://127.0.0.1:5500', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', 'http://localhost:3003', 'http://localhost:3004', 'http://localhost:3005']
