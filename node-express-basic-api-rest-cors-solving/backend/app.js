const { app, PORT } = require('./src/routing.js')
...
// // This code starts the Express server and logs a message to the console indicating that the server is running.
// // The server listens for incoming requests on the specified port (default is 3002).
